...
<div class="col-md-11 col-lg-12 order-md-last">
         ...
         <h46> <div class="gofarleft forlink col-12 col-sm-12 themed-grid-col" style='font-size:13px;'> <a href="./tiktokmembers"> مشتركين تيك توك : {{ $tiktokfollowers }} </a> </div>	 </h6>  
  ...
  <div class="col-md-11 col-lg-12 order-md-last">
    ...
    <a href="./pubgwinners" ><div class="winners-pubg" width="100%" height="100px" style="margin-right:-30px;">  </div> </a> 
    </div>

    <div class="col-lg-4" >
    <a href="./tiktokwinners" ><div class="winners-tiktok" width="100%" height="100px" style="margin-right:-30px;"> </div> </a> 
    </div>
