...
<div class="modal fade" id="exampleModalDefault" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="bgluky container">
              ...
              @if(!session()->has('backto'))
      <form class="needs-validation" novalidate action="{{route('createwinnerf')}}" method="post">
        @csrf 
        <div class="row g-3 my-3">
          <div class="col-md-12">
          <label for="idfreefire" class="form-label" style="font-size:14px;"> اكتب  اي دي فري فاير لاستلام الهدية </label>
          ...
          <input pattern="\d*" style="font-size:14px; text-align:left;" type="text" class="form-control" id="idfreefire" name="idfreefire" placeholder="اي دي فري فاير" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  class="@error('idfreefire') is-invalid @enderror">
          <div class="invalid-feedback">
          اكتب  اي دي فري فاير لاستلام الكود 
          </div>
          @error('idfreefire')
      ...
      @endif
              ...
              @else
        <form class="needs-validation" novalidate action="{{route('guessfreefire')}}" method="post">
                @csrf 
        <div class="row g-3 my-3">
            <div class="col-md-12">
              <label for="guessno" class="form-label" style="font-size:12px;">خمن رقم من 5 خانات واربح جواهر فري فاير</label>
