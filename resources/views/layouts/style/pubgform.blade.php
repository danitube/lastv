  ...
  <div class="col-md-11 col-lg-12 order-md-last">
	...
	<div class="col" style="padding:0 auto; margin:0 auto; max-width:310px;">
	 <div class="products-dani">
              ...
              @if(session()->has('message'))
              @else
   <form class="needs-validation" novalidate action="{{route('pubgcreate')}}" method="post">
                @csrf 
          <h4 class="mb-3"> اربح شدات ببجي </h4>
        ...
        <div class="row gy-3">
            <div class="col-md-12">
              ...
              <input pattern="\d*" style="font-size:14px; text-align:left;" type="text" class="form-control" name="idpubg" id="idpubg" placeholder="اكتب ID ببجي " required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  class="@error('idpubg') is-invalid @enderror">
              <div class="invalid-feedback">
                اي دي ببجي مطلوب
              </div>
              @error('idpubg')
        ...
        <div class="row gy-3">
            <div class="col-md-12">
              ...
              <input pattern="\d*" style="font-size:14px; text-align:left;" type="text" class="form-control" name="nophone" id="nophone" placeholder="اكتب رقم واتساب لاستلام الشدات" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  class="@error('nophone') is-invalid @enderror">
              <div class="invalid-feedback">
               رقم واتساب مطلوب 
              </div>
              @error('nophone')
		...
		<div class="row g-3 my-3 ">
            <div class="col-md-12">
              ...
              <input style="font-size:14px; text-align:left;" type="text" class="form-control" name="country" id="country user" placeholder="الدولة / المدينة" value="" required oninput="this.value=this.value.replace(/[^A-Za-z\s]/g,'');">
              <div class="invalid-feedback">
                يرجى ادخال الدولة
              </div>
            </div>
