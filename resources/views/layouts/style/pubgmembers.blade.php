...
<div class="col-md-11 col-lg-12 order-md-last">
          ...
          <h6> <div class="gofarright forlink col-12 col-sm-12 themed-grid-col" style='font-size:13px;font-weight:bold;'> <a href="./pubgmembers"> مشتركين ببجي : {{ $pubgfollowers }} </a> </div> </h6>	  
  ...
  <div class="col-md-11 col-lg-12 order-md-last">
	...
	<div class="col" style="padding:0 auto; margin:0 auto; max-width:310px;">
     ...
     @foreach ($gitInno as $pubg)
       <li class="list-group-item" style="text-align:center; border-bottom:1px dotted #000;">P{{ $pubg->inno }} </li>
     @endforeach
        </ul>
