...
<div class="col-md-11 col-lg-12 order-md-last">
          ...
          <h6> <div class="gofarright forlink col-12 col-sm-12 themed-grid-col" style='font-size:13px;font-weight:bold;'> <a href="./vodmembers"> مشتركين فودافون : {{ $vodafonefollowers }} </a> </div> </h6>
 </div>
  ...
  <div class="col-md-11 col-lg-12 order-md-last">
	...
	<div class="col" style="padding:0 auto; margin:0 auto; max-width:310px;">
     ...
     @foreach ($gitInno as $vod)
       <li class="list-group-item" style="text-align:center; border-bottom:1px dotted #000;">P{{ $vod->inno }} </li>
     @endforeach
        </ul>
